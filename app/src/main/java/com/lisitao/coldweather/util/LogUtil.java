...
public class LogUtil {
    ...
    private void printLog(String level, String TAG, String msg) {
        try {
    ...
    //格式化日志
    private String formatLog(String level, String TAG, String msg) {
    ...
    // 确认是否需要创建新日志文件
    private File isCreateLogFile(File file) {
